...
function loadLayerGroup(_layers) {
    ...
    function _loadLayer(index) {
        ...
        if(_layers[index].name == 'Railway Scene LoD3') {
...
function addTestLayers() {
    ...
    options.url = './../data/Railway_Scene_LoD3/Railway_Scene_LoD3_collada_MasterJSON.json'
    options.url = './../data/Railway_Scene_LoD3/Railway_Scene_LoD3_collada_MasterJSON.json'
    options.cityobjectsJsonUrl = './../data/Railway_Scene_LoD3/Railway_Scene_LoD3.json'
    options.name = 'Railway Scene LoD3'
    railwayLayer = new CitydbKmlLayer(options);
    layers.push(railwayLayer)

    options.url = './../data/Lots/NYC_Manhattan_Lots_footprint_MasterJSON.json'
    options.name = 'NYC Manhattan Lots footprint'
    lotLayer = new CitydbKmlLayer(options);
    layers.push(lotLayer)

    options.url = './../data/Streets/NYC_Manhattan_Streets_footprint_MasterJSON.json'
    options.name = 'NYC Manhattan Streets footprint'
    streetLayer = new CitydbKmlLayer(options);
    layers.push(streetLayer)

    // webMap.addLayer(buildingLayer);
    // webMap.addLayer(railwayLayer);
